...
public class Blackjack {
   public static void main(String[] args) {
      ...
      while(playerMoney > 0.0D && !gameOver) {
         ...
         System.out.println("You have $" + String.format("%.2f", playerMoney) + ", how much would you like to bet? ");
         double playerBet;
         while (true) {
             try {
                ...
                if (playerBet > playerMoney) {
                   ...
                   System.out.println("Please enter a number between 0 and " + String.format("%.2f", playerMoney) + "!");
                } else if (playerBet < 0) {
       ...
       //If player got blackjack (card value = 21), player wins 1.5x their bet.
         ...
         System.out.println("You currently have $" + String.format("%.2f", playerMoney) + ".");
      ...
      if (!invalidInput && !isRich && playerMoney == 0) {
      ...
      if (hasExited && !isRich) {
         if (playerMoney < initialMoney) {
            System.out.println("You have lost: $" + String.format("%.2f", initialMoney - playerMoney) + "!");
            System.out.println("Thank you for playing! We hope to see you soon!");
         } else {
            System.out.println("You have won: $" + String.format("%.2f", (playerMoney - initialMoney)) + "!");
            System.out.println("Thank you for playing! We hope to see you soon!");
         }
      }
